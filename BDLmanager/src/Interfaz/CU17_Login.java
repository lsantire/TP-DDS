...
public class CU17_Login extends javax.swing.JFrame  {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Interfaz/bdlmanager.png"))); // NOI18N

        jRadioButton1.setText("Bedel");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CU17_Login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
