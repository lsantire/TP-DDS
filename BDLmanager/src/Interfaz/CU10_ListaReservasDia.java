 ...
 * @author Facundo
 */
public class CU10_ListaReservasDia extends javax.swing.JFrame {

    /**
     * Creates new form ListaReservasDia
     */
    public CU10_ListaReservasDia() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingrese los datos para la búsqueda de reservas:");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Aula", "Tipo de aula", "Docente", "Nombre del curso", "Hora Inicio", "Hora Fin"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CU10_ListaReservasDia.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CU10_ListaReservasDia().setVisible(true);
            }
        });
    }
